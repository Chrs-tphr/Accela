...
//INSERT TEST CODE START
	...
	var latestInspResultDate = null;//var for latest valid inspection result date
	...
	if(inspectionArray.getSuccess()){
		...
		if(inspArray.length){
			for(i in inspArray){
				...
				var resultDate = new Date(thisInsp.getInspectionStatusDate().getEpochMilliseconds());
				var inspDate = new Date(thisInsp.getInspectionDate().getEpochMilliseconds());
